    ...
    <>
      <div className="min-h-screen pb-20">
        ...
        <nav className="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-40 text-sm">
          ...
          <div className="hidden md:flex items-center gap-8 transition duration-500 mt-2.5 text-slate-800">
          ...
          <div className="flex gap-2">
            <Link
              ...
              className="hidden md:block px-6 py-2 bg-custompurple hover:bg-purple-700 active:scale-95 transition-all rounded-full text-white"
              hidden={user}
            >
              Get started
            </Link>
            <Link
              to="/app?state=login"
              className="hidden md:block px-6 py-2 border active:scale-95 hover:bg-purple-50 transition-all rounded-full text-slate-700 hover:text-slate-900"
              hidden={user}
            >
              Login
            </Link>
        ...
        >
          ...
          <button
            ...
            className="active:ring-3 active:ring-white aspect-square size-10 p-1 items-center justify-center bg-purple-800 hover:bg-purple-700 transition text-white rounded-md flex"
          >
            X
          </button>
        </div>
        ...
        {/* Hero Section */}
        <div className="-mt-10 sm:mt-1 relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
          ...
          <h1 className="text-5xl md:text-6xl font-semibold max-w-5xl text-center  md:leading-[70px]">
            ...
            <span className=" bg-linear-to-r from-purple-800 to-purple-600 bg-clip-text text-transparent text-nowrap">
              AI Powered{" "}
            </span>{" "}
            Resume.
          </h1>
          ...
          <p className="max-w-md text-center text-base my-7">
            Land your dream job faster with an AI-powered resume that highlights
            your skills and experience perfectly.
          </p>
          ...
          <div className="flex items-center gap-4 ">
            <Link
              to="/app"
              className="bg-custompurple hover:bg-purple-700 text-white rounded-full px-9 h-12 m-1 ring-offset-2 ring-1 ring-purple-400 flex items-center transition-colors"
            >
              Get started
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          >
            {logos.map((logo, index) => (
              <img
                ...
                src={logo}
                alt="logo"
                className="h-12 opacity-40 w-auto max-w-xs"
              />
            ))}
          </div>
        </div>
