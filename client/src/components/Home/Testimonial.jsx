  ...
  const cardsData = [
    {
      ...
      name: 'Sarah Malik',
      handle: '@sarahdesigns',
      text: 'CreateAiResume helped me build a professional resume in minutes — the AI suggestions were perfectly aligned with my career goals.',
      date: 'April 20, 2025'
    },
    {
      ...
      name: 'Ali Raza',
      handle: '@devwithali',
      text: 'The templates are modern, ATS-friendly, and customizable. Got my first interview call in just days!',
      date: 'May 10, 2025'
    },
    {
      ...
      name: 'Hira Ahmed',
      handle: '@hira.codes',
      text: 'I loved how the AI optimized my resume for each job I applied to — it really stood out!',
      date: 'June 5, 2025'
    },
    {
      ...
      name: 'Usman Khan',
      handle: '@usmanbiz',
      text: 'I customized my resume design easily and downloaded it instantly. It’s the best resume builder I’ve used.',
      date: 'June 15, 2025'
    },
  ];
  ...
  return (
    <div>
      <div id="testimonials" className="flex flex-col items-center">
        <div className="flex items-center gap-2 text-sm text-custompurple bg-purple-400/10 border border-purple-200 rounded-full px-4 py-1">
          <BookUserIcon className='size-4.5 stroke-custompurple' />
          <span>Testimonials</span>
        </div>

        <Title 
          title="Don’t just take our words."
          description="See how professionals use CreateAiResume to land their dream jobs." 
        />
        ...
        <>
          ...
          {[false, true].map((reverse, i) => (
            <div key={i} className="marquee-row w-full mx-auto max-w-5xl overflow-hidden relative">
              ...
              <div className={`marquee-inner ${reverse ? 'marquee-reverse' : ''} flex transform-gpu min-w-[200%] pt-10 pb-5`}>
